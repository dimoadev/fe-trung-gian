...
const Footer = () => {
	...
	return (
		<div id='contact' className='relative -z-10'>
			<div className={`mt-4 bg-transparent rounded-[20px]  max-w-7xl mx-auto`}>
				<div
						...
						>
							<div className='bg-tertiary rounded-2xl p-2 mt-4 opacity-70'>
								{contact.map((social, index) => (
									<ContactCard key={social.icon} index={index} {...social} />
								))}
								<div
									style={{
										height: '110px',
				...
				<p className='mt-4 text-center pb-2 copyright'>
					@Copyright Net Connect {new Date().getFullYear()}
				</p>
			</div>
		</div>
	);
