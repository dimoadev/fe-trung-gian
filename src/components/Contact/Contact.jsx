  ...
  const handleSubmit = (e) => {
    ...
    emailjs
      .send(
        ...
        {
          from_name: form.name,
          to_name: "Trần Quốc Liêm",
          from_email: form.email,
          to_email: "tranquocliemc6@gmail.com",
          name: form.name,
          email: form.email,
      ...
      .then(
        () => {
          setLoading(false);
          alert(
            "Cảm ơn. Tôi sẽ phản hồi lại cho bạn trong thời gian sớm nhất."
          );
        ...
        (error) => {
          ...
          alert("Ahh, đã xảy ra lỗi. Vui lòng thử lại sau.");
        }
      );
  };
